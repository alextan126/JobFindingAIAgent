-- Enhanced job information table (PostgreSQL version)
...
CREATE TABLE IF NOT EXISTS job_info (
    ...
    scrape_success   BOOLEAN NOT NULL DEFAULT TRUE,  -- true = success, false = failure
    ...
    description      TEXT,
    requirements     JSONB,  -- JSON format: {"skills": [], "qualifications": [], "responsibilities": []}
